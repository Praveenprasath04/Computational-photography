...
signal1_flutter = A1_flutter(:, 1);
signal2_flutter = A2_flutter(:, 1);

% Compute the DFTs
dft_conventional = fft(signal_conventional);
dft2_flutter = fft(signal2_flutter);
dft1_flutter = fft(signal1_flutter);
...
magnitude1_flutter = 20 * log10(abs(dft1_flutter));
magnitude2_flutter = 20 * log10(abs(dft2_flutter));
...
plot(frequencies, magnitude2_flutter, 'r', 'DisplayName', 'Flutter Shutter 2 DFT');
plot(frequencies, magnitude1_flutter, 'g', 'DisplayName', 'Flutter Shutter 1 DFT');
